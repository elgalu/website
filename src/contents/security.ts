...
export const programFeatures: ProgramFeature[] = [
  {
    title: "Compliance",
    paragraphs: [
      "Gitpod is a European company committed to developer and data privacy. We are GDPR compliant and provide our users with the ability to access and control the information that we collect about them.",
